    ...
    <div class="bg-white w-full md:w-1/3 px-8 pt-8 pb-3 flex flex-col justify-between">
        <div>
            ...
            <form class="mt-4" @submit.prevent="onSubmit">
                ...
                <button type="submit" class="btn btn-success btn-block"><?= __('Check In')?></button>
            </form>
        </div>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            getQuotes: function() {
                // Alternative Free Quotes API: https://api.quotable.io/random axios.get('https://slims.web.id/kutipan/')
                axios.get('localhost/smpsms/js/quote.js')
                    .then(res => {
                    ...
                    .catch(() => {
                        this.quotes = {
                            content: "Kedamaian dimulai dengan senyuman.",
                            author: "Bunda Teresa"
                        }
                    })
                    .finally(() => {
